                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-image" style="font-size: 0px;">
                                                                                        <a target="_blank" href="http://homestead.test/"><img class="adapt-img" src="https://demo.stripocdn.email/content/guids/053bcb09-9112-452b-9553-80357ccca98c/images/hanfit.png" alt="Logo" style="display: block;" height="89" title="Logo"></a>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text es-p5t es-p5b es-p40r es-m-p0r" esd-links-underline="none">
                                                                                        <p>Gracias por escoger Hanfit.&nbsp;</p>
                                                                                        <p>Recibiste este correo electrónico porque recibimos una solicitud de restablecimiento de contraseña para tu cuenta. Este link caducará en 60 minutos. Si no has recibido una enviado una solicitud de restablecimiento de contraseña, ignora este correo electrónico.</p>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-spacer es-p10t es-p10b es-m-txt-c" style="font-size:0">
                                                                                ...
                                                                                <tr>                                                                                                                                                 
                                                                                    <td align="center" class="esd-block-button es-p10t es-p10b es-m-txt-l"><span class="es-button-border" style="background: #ffffff;"><a href= {{ $actionUrl }}  class="es-button" target="_blank" style="background: #ffffff; border-color: #ffffff;">Cambiar mi contraseña</a></span></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
                                                                                            ...
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td align="center" valign="top" class="es-p30r">
                                                                                                        <a target="_blank" href="https://www.facebook.com/hanfitwellnessvillajoyosa/"><img title="Facebook" src="https://tlr.stripocdn.email/content/assets/img/social-icons/square-black-bordered/facebook-square-black-bordered.png" alt="Fb" width="32"></a>
                                                                                                    </td>
                                                                                                    <td align="center" valign="top">
                                                                                                        <a target="_blank" href="https://www.instagram.com/hanfit_wellness_center_la_vila/?hl=es"><img title="Instagram" src="https://tlr.stripocdn.email/content/assets/img/social-icons/square-black-bordered/instagram-square-black-bordered.png" alt="Inst" width="32"></a>
                                                                                                    </td>
                                                                                                </tr>
                                                                                            </tbody>
                                                                                        </table>
