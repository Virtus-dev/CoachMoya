                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text">
                                                                                        <h2>Verifica tu email para finalizar.</h2>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                ...
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text es-p5t es-p5b es-p40r es-m-p0r" esd-links-underline="none">
                                                                                        ...
                                                                                        <p>Por favor, confirma que {{$user['email']}} es tu direccion de email clicando en el botón de abajo , el link caducará a los 60 min. Si usted no ha solicitado esto, ignore este correo electrónico.</p>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-spacer es-p10t es-p10b es-m-txt-c" style="font-size:0">
                                                                                ...
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-button es-p10t es-p10b es-m-txt-l"><span class="es-button-border" style="background: #ffffff;"><a href="{{url('user/verify', $user->verifyUser->token)}}" class="es-button" target="_blank" style="background: #ffffff; border-color: #ffffff;">Verifica mi email</a></span></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
