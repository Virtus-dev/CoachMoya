...
<form method='post' action="{{route('insertWorkouts')}}">
  ...
  <tbody>
    <tr>
      ...
      <td scope="col">
       <div style="margin: auto; width: 220px;">
         <input id="marca_id" type="text" class="form-control @error('marca_id') is-invalid @enderror" name="marca_id[]" value="{{ old('marca_id') }}" required autocomplete="marca_id" autofocus>
